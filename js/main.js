...
// ============================================
// 7. Odix ASSISTANT - البوت التفاعلي (نسخة دروب داون)
// ============================================
...
const faqData = {
    ...
    'q5': 'نعم، Odix متوافق مع جميع أنواع طابعات الكاشير والباركود وقوارئ الرموز (Barcode Scanners) وأنظمة نقاط البيع POS.',
    'q6': 'يوفر Odix مجموعة شاملة من التقارير المالية والإدارية مثل الأرباح والخسائر، المبيعات اليومية، حركة المخزون، وتقارير العملاء والموردين.',
    'q7': 'نعم، يعمل فريق الدعم الفني على مدار الساعة لضمان استقرار النظام واستمرارية عملك دون انقطاع.',
    'q8': 'بالتأكيد. جميع عملاء Odix يحصلون على دعم فني مجاني بعد الشراء، بالإضافة إلى تحديثات وتحسينات مستمرة للنظام.',
    'q9': 'لا، واجهة Odix مصممة لتكون سهلة الاستخدام حتى لغير المحاسبين، مع شروحات وفيديوهات توضيحية داخل النظام.',
    'q10': 'بالتأكيد، Odix يعتمد على أنظمة حماية قوية وتشفير متقدم لضمان سرية بياناتك ومنع أي وصول غير مصرح به.'
};
...
if (dropdownBtn && dropdownMenu) {
    ...
    console.log('✅ Odix website loaded successfully!');
});